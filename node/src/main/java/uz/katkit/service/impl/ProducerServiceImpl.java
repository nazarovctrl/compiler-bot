...
public class ProducerServiceImpl implements IProducerService {
    ...
    @Override
    public void producerDelete(DeleteMessage deleteMessage) {
        rabbitTemplate.convertAndSend(RabbitQueue.DELETE_MESSAGE, deleteMessage);
    }

    @Override
    public void producerDocument(DocumentMessageDTO documentMessage) {
        rabbitTemplate.convertAndSend(RabbitQueue.DOCUMENT_MESSAGE, documentMessage);
    }
